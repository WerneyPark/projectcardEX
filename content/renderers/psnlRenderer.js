class PsnlRenderer extends BaseRenderer {
    async renderCard(data, ctx, canvas) {
        canvas.width = 419;
        canvas.height = 595;

        const imageSources = {
            imgTplat1psnl: "https://projectcard.com.br/img/ALFA/psnlegendsbordat1.png",
            imgTplat2psnl: "https://projectcard.com.br/img/ALFA/psnlegendsbordat2.png",
            imgTplat3psnl: "https://projectcard.com.br/img/ALFA/psnlegendsbordat3.png",
            imgTplat4psnl: "https://projectcard.com.br/img/ALFA/psnlegendsbordat4.png",
            imgFundopsnl: "https://projectcard.com.br/img/ALFA/basepsnl.png",
            imgTperfpsnl: "https://projectcard.com.br/img/ALFA/psnlegendsborda.png",
        ...
        ctx.drawImage(images.imgFundopsnl, 0, 0);

        if (images.avatar) {
            ctx.drawImage(images.avatar, 44, 108, 273, 273);
            ctx.drawImage(images.imgTperfpsnl, 0, 0);
        }
        ...
        // Desenhar Platinas Mais Raras (Fallback handled by skipping Se nulo)
        const platPositions = [
            { x: 325, y: 108 },
            { x: 325, y: 180 },
            { x: 325, y: 249 },
        ...
        const bordaplat = [images.imgTplat1psnl, images.imgTplat2psnl, images.imgTplat3psnl, images.imgTplat4psnl];
